...
const SIZES: Record<CtaSize, { box: string; text: string; arrow: number }> = {
  sm: { box: 'gap-2 px-5 py-2.5', text: 'text-[13px] md:text-[14px]', arrow: 15 },
  md: { box: 'gap-2.5 px-7 py-3 md:py-3.5', text: 'text-[15px] md:text-[16px]', arrow: 18 },
  lg: { box: 'gap-3 px-7 md:px-8 py-3 md:py-3.5', text: 'text-[18px] md:text-[22px]', arrow: 26 },
}
